...
export const SYMPTOMS: string[] = [
    ...
    'Bloody Stool', 'Irritation In Anus', 'Neck Pain', 'Dizziness', 'Cramps',

    'Bruising', 'Obesity', 'Swollen Legs', 'Swollen Blood Vessels',
    ...
    'Fluid Overload', 'Blood In Sputum', 'Prominent Veins On Calves',
